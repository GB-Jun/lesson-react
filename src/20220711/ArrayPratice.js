...
function Arraypratice() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => {
          const newData = data.filter(function (v) {
            console.log(v.text.indexOf('a'));
            return v.text.indexOf('a') >= 0;
          });
          setData(newData);
        }}
      >
      ...
      <button
        onClick={() => {
          const newData = [...data];
          const back = newData.splice(2);
          newData.push({ id: 5, text: 'bbb' });
          setData(newData);
        }}
      >
